(() => {
  ...
  function guestPage() {
    return `<div class="page-shell" id="home">
      ...
      <section class="join-strip"><div><h2>Make a little extra mean a lot.</h2><p>Sign up as a restaurant or volunteer and start nearby.</p></div><button class="button button-primary" type="button" data-action="signup">Join PaatraSetu <span class="button-arrow">→</span></button></section>
    </div>`;
  }
